...
import ankabut.scripts.ankabut_config as config
from ankabut.gui.settings_ui import Ui_Dialog
...
class Settings(QtWidgets.QDialog , Ui_Dialog ):
    ...
    def reset_button_clicked(self):
        try:
            ...
            QtWidgets.QMessageBox.information(self,'Ankabut','data was updated')
    ...
    def change_query_combos_changed(self):
        try:
            ...
            QtWidgets.QMessageBox.information(self,'Ankabut',str(e))
