...
from ankabut.gui.ask_download_ui import Ui_Dialog
...
class AskDialog(QDialog , Ui_Dialog):
    ...
    def showEvent(self,event):
        ...
        if result:
            ans=QMessageBox.question(self.parent,'Ankabut','you have downloaded this file before, would you like to delete the file and continue ?')
