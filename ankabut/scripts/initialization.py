#!/usr/bin/python3
from ankabut.scripts import usefultools
import platform
import os
...
if os_type == 'Linux':
    config_folder = os.path.join(user_path , '.config/Ankabut')

elif os_type == 'Windows':
    config_folder = os.path.join(user_path , 'AppData','local','Ankabut')
...
config_file = os.path.join(config_folder,'ankabut.config')
...
download_path = os.path.join(user_path , 'Downloads' , 'Ankabut')
